                        ...
                        <c:forEach items="${userMsgs.list}" var="user">
                            <tr>
                                ...
                                <td width="27%">
                                    ...
                                    <c:if test="${user.talkStatus==0}">
                                        <a href="/user/changeTalkStatus.do?id=${user.userId}&pn=${userMsgs.pageNum}&username=${userSearch.userName}&role=${userSearch.role}" role="button" class="btn btn-danger" style="right: 0px">禁言</a>
                                    </c:if>
                                    <c:if test="${user.talkStatus==1}">
                                        <a href="/user/changeTalkStatus.do?id=${user.userId}&pn=${userMsgs.pageNum}&username=${userSearch.userName}&role=${userSearch.role}" role="button" class="btn btn-info" style="right: 0px">恢复</a>
                                    </c:if>
                                </td>
                            </tr>
                        </c:forEach>
