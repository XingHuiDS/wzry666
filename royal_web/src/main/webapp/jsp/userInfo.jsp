...
<head>
    ...
    <script>
        ...
        function tipianF() {
            ...
            $.post("${pageContext.request.contextPath}/user/tupianYY.do", {"tupian1Id": tupian1Id}, function (data) {
                if (data.zt) {
                    touxiangZT1 = true;
                    //图片可以使用
                    xianshi.css("color", "green");
            ...
            $("#BC1Input").click(function () {
                if (oldPasswordF() && newPasswordF()) {
                    ...
                    $.post(${pageContext.request.contextPath}"/user/passPD.do", {
                        ...
                        if (date.zt1) {
                            alert("密码修改成功")
                            location.href = '${pageContext.request.contextPath}/user/Quit.do';
                        } else {
                            alert("旧密码错误")
                        }
                    }, "json");
            ...
            $("#update").click(function () {
                if (isupdating === 1) {
                    ...
                    if (count < 5) {
                        ...
                        $.ajax({
                            "url": "${pageContext.request.contextPath}/user/changeIsUpdating",
                            'type': "post",
                            "success": function (data) {
                                alert("申请成功，请耐心等待审批");
                                location.reload();
...
<div class="hm-top-nav">
    <div class="hm-inner clearfix">
        ...
        <div class="hm-inner-r r">
            <div class="box">
                欢迎<a href="userInfo.jsp" style="margin-right:0px;padding:0px 5px;color:blue;">scott</a>回来！
                <a href="#">【注销】</a>
                <div id="dialogBg"></div>
    ...
    <div class="hm-inner">
        <div class="user-info clearfix">
            ...
            <div class="user-info-l l">
                ...
                <ul class="user-info-l-b" id="lefUL">
            ...
            <div class="user-info-r r">
                <ul class="clearfix hd" id="rightUL">
                ...
                <form id=form_0 action=${pageContext.request.contextPath}"/user/update.do" method="post"
                      enctype="multipart/form-data">
                    <ul class="bd">
                        <li class="clearfix">
                            <div class="info-l"><i class="red">*</i>用户名：</div>
                            <div class="info-r"><input type="text" name="userName" class="txt"
                                                       value="${sessionScope.user.userName}" readonly="readonly"/></div>
                        </li>
                        <li class="clearfix">
                            <div class="info-l">邮箱地址：</div>
                            <div class="info-r"><input type="text" name="email" class="txt" value="" id="emailId"
                                                       onblur="emailF()"/></div>
                        </li>
                        <li class="clearfix">
