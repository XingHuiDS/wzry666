...
<head>
    ...
    <script>
        ...
        function tipianF() {
            ...
            $.post("${pageContext.request.contextPath}/userInfo/tupianYY.do", {"tupian1Id": tupian1Id}, function (data) {
                if (data.zt) {
                    touxiangZT1 = true;
                    //图片可以使用
                    xianshi.css("color", "green");
...
<div class="hm-header">
    <div class="hm-inner clearfix">
        ...
        <div class="hm-header-b">
            ...
            <a href=${pageContext.request.contextPath}"/index/show">首页</a><span>></span>个人信息<%--跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页跳转至主页--%>
        </div>
    </div>
</div>
